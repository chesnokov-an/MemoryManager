...
public:
    ...
    virtual void get_raw_value(std::byte* value, size_t begin = 0, size_t end = 0) const = 0;
    virtual void set_raw_value(const std::byte* value, size_t begin = 0, size_t end = 0) = 0;
